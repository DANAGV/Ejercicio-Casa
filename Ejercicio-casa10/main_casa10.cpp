...
//*****Movimiento del carro con limites en el trayecto y un un giro oara cada extremo
//***** Teclas de manipulacion
//***** Con la barra espaciadora se reinica el moviento
//***** p el carro ira hacia adelante
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				if (movKit <= -128.5) //se limitan los rangos
					movKit = movKit + 0.5;
					glRotatef(movKit, 0, 1, 0);//agraga giro del carro
