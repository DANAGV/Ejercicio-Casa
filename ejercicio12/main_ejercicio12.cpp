...
//*************					Visual Studio 2017								*************//
//************* Este programa muestra el recorrido de un automovil que vuela en un pedazo trayecto *************//
	...
	if(circuito)
	{
		...
		if(recorrido5)
		{
			...
			if (movKitZ < 100)
			{
				//rotKit = 215;    //rotacion del auto
				movKitX++;
				if (movKitX > 80) //limite en z punto E
				{
					//movKitZ--;                            //moviento en Z							
					recorrido5 = false;
					recorrido6 = true;
